package com.monkey.springboot.demo.google;
...
public class GoogleAuthenticator {
    ...
    public static Boolean authcode(String codes, String savedSecret) {
        ...
        // should give 2 * 30 seconds of grace...
        ga.setWindowSize(2);
    ...
    public static String genSecret() {
        ...
        // Method of generating TWO-DIMENSIONAL code,Temporary don't have to
        String testhost = GoogleAuthenticator.getQRBarcodeURL("testuser",
                "testhost", secret);
        return secret;
    }
